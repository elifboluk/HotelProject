...
namespace OtelProject.Formlar.Tanımlamalar
{
    public partial class FrmKur : Form
    {
        ...
        {
            db.TblKur.Load(); // Load metoduyla bize TblKur değerleri yükleyecek.
            bindingSource1.DataSource = db.TblKur.Local; // Binding Source'un veri kaynağı = db.TblKasa.Local (Local komutu ile birim tablosuna verileri göndereceğiz.) (ToList yerine load ve local komutları kullandık. Peki neleri listeleyecek? -Run designer kısmına gönderdiğimiz sütunları [Durum ID ve Durum Adı] listeleyecek.)
